export const exampleEntryQuestionnaire = {
  type: "entry",
  sections: [
    {
      ...
      questions: [
        {
          id: "D1",
          text: "Are you a Software Engineer working at least 40% remotely? (This is required for participation)",
          responseType: "select",
          options: [
            { value: 1, label: "Yes" },
            { value: 0, label: "No" },
        ...
        {
          id: "D2",
          text: "Do you already regularly practice 4-7-8 breathing? (If so, you are unfortunately not eligible for this intervention) ",
          responseType: "select",
          options: [
            { value: 1, label: "Yes" },
            { value: 0, label: "No" },
        ...
        {
          id: "D3",
          text: "How many years have you worked as a Software Engineer?",
          responseType: "number",
        },
        {
          id: "D4",
        ...
        {
          id: "D6",
          text: "What level of experience do you have with mindfulness?",
          responseType: "select",
          options: [
            { value: 1, label: "None" },
